...
using NLog;
using Kotocorn.Modules.Utility.Extensions;
using Kotocorn.Common.TypeReaders;
using Kotocorn.Modules.Utility.Common;
using Kotocorn.Modules.Utility.Common.Exceptions;
using Discord.Net;

namespace Kotocorn.Modules.Utility.Services
{
    public class StreamRoleService : INService, IUnloadableService
    {
        ...
        public StreamRoleService(DiscordSocketClient client, DbService db, Kotocorn bot)
        {
