...
{
    public partial class Utility : KotocornTopLevelModule
    {
        ...
        public Utility(Kotocorn Kotocorn, DiscordSocketClient client, 
        ...
        public async Task Stats()
        {
            ...
            await Context.Channel.EmbedAsync(
                new EmbedBuilder().WithOkColor()
                    .WithAuthor(eab => eab.WithName($"Kotocorn v{StatsService.BotVersion}")
                                          .WithUrl("http://Kotocorn.readthedocs.io/en/latest/")
                                          .WithIconUrl("https://i.imgur.com/mNQ0rsA.png"))
