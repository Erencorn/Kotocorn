...
namespace Kotocorn.Modules.Games.Services
{
    public class PollService : IEarlyBlockingExecutor, INService
    {
        ...
        private readonly KotocornStrings _strs;

        public PollService(DiscordSocketClient client, KotocornStrings strings, DbService db,
            KotocornStrings strs, IUnitOfWork uow)
        {
