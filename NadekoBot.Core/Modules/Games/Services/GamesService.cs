...
using NLog;
using Kotocorn.Modules.Games.Common.Acrophobia;
using Kotocorn.Modules.Games.Common.Hangman;
using Kotocorn.Modules.Games.Common.Trivia;
using Kotocorn.Modules.Games.Common.Nunchi;

namespace Kotocorn.Modules.Games.Services
{
    public class GamesService : INService, IUnloadableService
    {
        ...
        private readonly KotocornRandom _rng;
