...
namespace Kotocorn.Modules.Games
{
    ...
    */
    public partial class Games : KotocornTopLevelModule<GamesService>
    {
        ...
        public async Task EightBall([Remainder] string question = null)
        {
            ...
            await Context.Channel.EmbedAsync(new EmbedBuilder().WithColor(Kotocorn.OkColor)
                               ...
                               .AddField(efb => efb.WithName("🎱 " + GetText("8ball")).WithValue(_service.EightBallResponses[new KotocornRandom().Next(0, _service.EightBallResponses.Length)]).WithIsInline(false)));
        }
