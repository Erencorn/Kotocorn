...
namespace Kotocorn.Modules.Games.Common
{
    public class TicTacToe
    {
        public class Options : IKotocornCommandOptions
        {
        ...
        public TicTacToe(KotocornStrings strings, DiscordSocketClient client, ITextChannel channel, 
