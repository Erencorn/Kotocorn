...
using Kotocorn.Modules.Music.Extensions;
using Kotocorn.Modules.Music.Services;
using Newtonsoft.Json.Linq;

namespace Kotocorn.Modules.Music
{
    [NoPublicBot]
    public class Music : KotocornTopLevelModule<MusicService>
    {
        ...
        public async Task SoundCloudPl([Remainder] string pl)
        {
            ...
            {
                var scvids = JObject.Parse(await http.GetStringAsync($"https://scapi.Kotocorn.me/resolve?url={pl}").ConfigureAwait(false))["tracks"].ToObject<SoundCloudVideo[]>();
                IUserMessage msg = null;
