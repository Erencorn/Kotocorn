...
using Kotocorn.Common.ShardCom;
...
namespace Kotocorn.Modules.Administration.Services
{
    public class SelfService : ILateExecutor, INService
    {
        ...
        private readonly Kotocorn _bot;
        ...
        public SelfService(DiscordSocketClient client, Kotocorn bot, CommandHandler cmdHandler, DbService db,
            IBotConfigProvider bc, ILocalization localization, KotocornStrings strings, IBotCredentials creds,
            IDataCache cache)
        {
            _redis = cache.Redis;
            _bot = bot;
