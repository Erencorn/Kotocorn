...
using Kotocorn.Core.Modules.Gambling.Common.AnimalRacing;
using Kotocorn.Core.Services;
using Kotocorn.Extensions;
using Kotocorn.Modules.Gambling.Common.AnimalRacing;
using Kotocorn.Modules.Gambling.Common.AnimalRacing.Exceptions;
...
namespace Kotocorn.Modules.Gambling
{
    public partial class Gambling
    {
        ...
        public class AnimalRacingCommands : GamblingSubmodule<AnimalRaceService>
        {
            ...
            [KotocornOptions(typeof(RaceOptions))]
