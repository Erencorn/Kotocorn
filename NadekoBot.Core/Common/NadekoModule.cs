...
{
    public abstract class KotocornTopLevelModule : ModuleBase
    {
        ...
        public KotocornStrings _strings { get; set; }
        ...
        protected KotocornTopLevelModule(bool isTopLevelModule = true)
        {
        ...
        //{
        //    var title = Kotocorn.ResponsesResourceManager.GetString(titleKey, cultureInfo);
        //    var text = Kotocorn.ResponsesResourceManager.GetString(textKey, cultureInfo);
    ...
    public abstract class KotocornTopLevelModule<TService> : KotocornTopLevelModule where TService : INService
    {
        public TService _service { get; set; }

        public KotocornTopLevelModule(bool isTopLevel = true) : base(isTopLevel)
        {
        }
    }

    public abstract class KotocornSubmodule : KotocornTopLevelModule
    {
        protected KotocornSubmodule() : base(false) { }
    }

    public abstract class KotocornSubmodule<TService> : KotocornTopLevelModule<TService> where TService : INService
    {
        protected KotocornSubmodule() : base(false)
        {
        }
