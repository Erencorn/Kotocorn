...
namespace Kotocorn
{
    public class Kotocorn
    {
        ...
        public Kotocorn(int shardId, int parentProcessId)
        {
            if (shardId < 0)
        ...
        private void AddServices()
        {
            ...
            using (var uow = _db.UnitOfWork)
            {
                ...
                LoadTypeReaders(typeof(Kotocorn).Assembly);
            }
        ...
        public async Task RunAsync(params string[] args)
        {
            ...
            bool isPublicKotocorn = false;
#if GLOBAL_Kotocorn
            isPublicKotocorn = true;
#endif
        ...
        //                                        "modules",
        //                                        $"Kotocorn.Modules.{name}",
        //                                        $"Kotocorn.Modules.{name}.dll"));
