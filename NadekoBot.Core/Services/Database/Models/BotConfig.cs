...
namespace Kotocorn.Core.Services.Database.Models
{
    public class BotConfig : DbEntity
    {
        ...
        public string CurrencyName { get; set; } = "Kotocorn Flower";
        public string CurrencyPluralName { get; set; } = "Kotocorn Flowers";
...
Kotocorn Support Server: https://discord.gg/Kotocorn";
