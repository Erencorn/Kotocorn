...
#define version GetEnv("Kotocorn_INSTALL_VERSION")
#define target "win7-x64"

[Setup]
AppName=Kotocorn
AppVersion={#version}
AppPublisher=Erencorn
DefaultDirName={pf}\Kotocorn
DefaultGroupName=Kotocorn
UninstallDisplayIcon={app}\{#sysfolder}\nadeko_icon.ico
Compression=lzma2
SolidCompression=yes
OutputDir=userdocs:projekti/NadekoInstallerOutput
OutputBaseFilename=Kotocorn-setup-{#version}
AppReadmeFile=http://Kotocorn.readthedocs.io/en/latest/Commands%20List/
...
[Run]
Filename: "http://Kotocorn.readthedocs.io/en/latest/JSON%20Explanations/"; Flags: postinstall shellexec runasoriginaluser; Description: "Open setup guide"
...
Name: "{app}\Kotocorn"; Filename: "{app}\{#sysfolder}\Kotocorn.exe"; IconFilename: "{app}\{#sysfolder}\nadeko_icon.ico"
Name: "{app}\credentials"; Filename: "{app}\{#sysfolder}\credentials.json" 
Name: "{app}\data"; Filename: "{app}\{#sysfolder}\data" 

; desktop shortcut 
Name: "{commondesktop}\Kotocorn"; Filename: "{app}\Kotocorn"; Tasks: desktopicon
...
Root: "HKLM"; Subkey: "SOFTWARE\Microsoft\Windows NT\CurrentVersion\AppCompatFlags\Layers"; \
    ValueType: String; ValueName: "{app}\{#sysfolder}\Kotocorn.exe"; ValueData: "RUNASADMIN"; \
...
Root: "HKCU"; Subkey: "SOFTWARE\Microsoft\Windows NT\CurrentVersion\AppCompatFlags\Layers"; \
    ValueType: String; ValueName: "{app}\{#sysfolder}\Kotocorn.exe"; ValueData: "RUNASADMIN"; \
    Flags: uninsdeletekeyifempty uninsdeletevalue;
Root: "HKLM"; Subkey: "SOFTWARE\Kotocorn"; \
...
[Messages]
WelcomeLabel2=IMPORTANT! READ BELOW!%n%nIt is recommended that you CLOSE any ANTI VIRUS before continuing.%n%nYou can only update v1.4 or newer.%n%nDo not select your old Kotocorn folder as an install path if it's not 1.4 or newer.
...
begin
  ...
  begin
    ...
    if FileExists(X + '\{#sysfolder}\data\Kotocorn.db') then begin
      ...
      MsgBox(X + '\{#sysfolder}\data\Kotocorn.db doesn''t exist', mbConfirmation, MB_YESNO)
    end
  end;
end;
